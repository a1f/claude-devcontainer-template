...
#
# Addition: reads /workspace/.devcontainer/firewall-extra-domains.txt
# for per-repo domain allowlisting.
...
# Default allowed domains (from Anthropic's reference)
ALLOWED_DOMAINS=(
    "registry.npmjs.org"
    "api.anthropic.com"
    "sentry.io"
...
# Load per-repo extra domains if the file exists
